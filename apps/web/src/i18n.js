const translations = {
  en: {
    ...
    home: {
      ...
      recommendationTitle: 'Explore our architecture categories',
      recommendationText: 'A curated selection of spaces that inspire and elevate the way people live.',
  ...
  es: {
    ...
    home: {
      ...
      recommendationTitle: 'Explora nuestras categorías de arquitectura',
      recommendationText: 'Una selección curada de espacios que inspiran y elevan la forma de habitar.',
